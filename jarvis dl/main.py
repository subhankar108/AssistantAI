...
def main_process():
    ...
    while True:
        ...
        if "hello" in request:
            ...
            pwk.sendwhatmsg("+917847913185", "Hi, How are you", 2, 10, 30)
        ...
        #     speak("Email sent")
            ...
            s.starttls()
            s.login("220301120106@cutm.ac.in", user_config.gmail_password)
            message = """
            This is the message.
            ...
            """
            s.sendmail("220301120106@cutm.ac.in", "220301120106@cutm.ac.in", message)
            s.quit()
            speak("Email sent")
